...
//	String ldifFiles = "resources\\users-import.ldif";
...
//		assertThat(0, equalTo(searchResult.getEntryCount()));
//		List<SearchResultEntry> searchEntries = searchResult.getSearchEntries();
//		assertThat(searchEntries.get(0).getAttribute("cn").getValue(), equalTo("Micha Kops"));
//		assertThat(searchEntries.get(1).getAttribute("cn").getValue(), equalTo("Santa Claus"));
//		assertThat(searchEntries.get(2).getAttribute("cn").getValue(), equalTo("John Steinbeck"));
//	}
	...
	public void shouldFindExactPerson() throws Exception {
		...
		final SearchResult searchResult = ldapConnection.search("cn=Santa Claus,ou=Users,dc=example,dc=com",
				SearchScope.BASE, "(objectClass=person)");
